...
ROS user and developer community [3]_, [6]_.  Everyone understood that
...
included one from some other package.  In that case, the necessary
...
``<exec_depend>`` generally refers to a run-time binary package.
...
.. [7] Buildsystem mailing list discussion: `"Request for comment REP 127"
   <https://groups.google.com/forum/?fromgroups=#!topic/ros-sig-buildsystem/_jRvhXFfsVk>`_
.. [8] Buildsystem mailing list discussion: `"Dependency tag types for REP 127"
   <https://groups.google.com/forum/?fromgroups=#!topic/ros-sig-buildsystem/fXGSZG0SC08>`_
.. [9] Buildsystem mailing list discussion: `"dev/non-dev packages and required meta information:
